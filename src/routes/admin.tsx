...
export default function Admin() {
  ...
  return (
    <main class="max-w-xl mx-auto px-4 py-8 text-neutral-300">
      <h1 class="text-2xl font-light text-neutral-100 mb-6">{t("admin.title")}</h1>
      ...
      {!token() ? (
        ...
        <>
          <div class="mb-6 flex items-center justify-between">
            <A href="/" class="text-neutral-400 hover:text-neutral-200">
              {t("nav.home")}
            </A>
